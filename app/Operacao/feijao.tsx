...
export default function Feijao() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Feijão</Text>
        ...
        ListEmptyComponent={
          !carregando ? (
            <Text style={styles.vazio}>
              Nenhum subtipo de feijão disponível.
            </Text>
          ) : null
        }
        renderItem={({ item }) => (
      ...
      <Modal visible={modalVisivel} transparent animationType="slide">
        {/* KeyboardAvoidingView garante que a caixa suba junto com o teclado */}
        <KeyboardAvoidingView
          style={styles.modalFundo}
          behavior={Platform.OS === "ios" ? "padding" : "height"}
          keyboardVerticalOffset={Platform.OS === "ios" ? 0 : 20}
        >
          {/* Fecha o teclado ao tocar fora da caixa de texto */}
